---
title: "Guide des bonnes pratiques dans R"
...
Ce document explique les ***regles importantes*** a respecter quand on utilise `R` ou `RStudio`. Iol faut toujours respecter ces quelques regles afin d'eviter *des erreurs reccurentes*.
